...
$launcher = Join-Path $repoRoot "scripts\windows\Start-ClawCode.ps1"
...
$shortcut.Description = "Launch Claw Code with Windows logging"
...
Write-Host "Logs: $env:LOCALAPPDATA\ClawCode\logs"
