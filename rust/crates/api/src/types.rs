...
pub struct MessageRequest {
    ...
    /// Thinking configuration for DeepSeek V4 (and compatible reasoning models).
    /// E.g. `{"type": "enabled"}` to enable chain-of-thought visibility.
    /// Omitted when `None`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub thinking: Option<ThinkingConfig>,
}

/// Thinking mode configuration for DeepSeek V4 / reasoning models.
